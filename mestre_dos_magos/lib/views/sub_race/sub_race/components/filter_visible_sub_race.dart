...
class FilterVisibleSubRace extends StatefulWidget {
  FilterVisibleSubRace({super.key, required this.filterStore});

  final FilterSearchStore filterStore;

  @override
  State<FilterVisibleSubRace> createState() => _FilterVisibleSubRaceState();
}

class _FilterVisibleSubRaceState extends State<FilterVisibleSubRace> {
  //recebe uma copia do filtro que esta na HomeStore
  final FilterSearchStore filterStoreGet = GetIt.I<FilterSearchStore>();

  final SubRaceStore subRaceStore = GetIt.I<SubRaceStore>();
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        subRaceStore.setFilter(widget.filterStore);
