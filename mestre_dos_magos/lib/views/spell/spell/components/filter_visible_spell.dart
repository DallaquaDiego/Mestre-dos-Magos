...
class FilterVisibleSpell extends StatefulWidget {
  FilterVisibleSpell({super.key, required this.filterStore});

  final FilterSearchStore filterStore;

  @override
  State<FilterVisibleSpell> createState() => _FilterVisibleSpellState();
}

class _FilterVisibleSpellState extends State<FilterVisibleSpell> {
  //recebe uma copia do filtro que esta na HomeStore
  final FilterSearchStore filterStoreGet = GetIt.I<FilterSearchStore>();

  final SpellStore spellStore = GetIt.I<SpellStore>();
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        spellStore.setFilter(widget.filterStore);
