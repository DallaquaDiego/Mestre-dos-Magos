...
class FilterVisibleRacialTrait extends StatefulWidget {
  FilterVisibleRacialTrait({super.key, required this.filterStore});

  final FilterSearchStore filterStore;

  @override
  State<FilterVisibleRacialTrait> createState() => _FilterVisibleRacialTraitState();
}

class _FilterVisibleRacialTraitState extends State<FilterVisibleRacialTrait> {
  //recebe uma copia do filtro que esta na HomeStore
  final FilterSearchStore filterStoreGet = GetIt.I<FilterSearchStore>();

  final RacialTraitStore racialTraitStore = GetIt.I<RacialTraitStore>();
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        racialTraitStore.setFilter(widget.filterStore);
