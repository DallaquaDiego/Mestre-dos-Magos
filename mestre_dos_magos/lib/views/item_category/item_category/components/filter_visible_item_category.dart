...
class FilterVisibleItemCategory extends StatefulWidget {
  FilterVisibleItemCategory({super.key, required this.filterStore});

  final FilterSearchStore filterStore;

  @override
  State<FilterVisibleItemCategory> createState() => _FilterVisibleItemCategoryState();
}

class _FilterVisibleItemCategoryState extends State<FilterVisibleItemCategory> {
  //recebe uma copia do filtro que esta na HomeStore
  final FilterSearchStore filterStoreGet = GetIt.I<FilterSearchStore>();

  final ItemCategoryStore itemCategoryStore = GetIt.I<ItemCategoryStore>();
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        itemCategoryStore.setFilter(widget.filterStore);
