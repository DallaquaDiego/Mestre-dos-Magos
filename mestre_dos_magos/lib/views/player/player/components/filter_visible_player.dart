...
class FilterVisiblePlayer extends StatefulWidget {
  FilterVisiblePlayer({super.key, required this.filterStore});

  final FilterSearchStore filterStore;

  @override
  State<FilterVisiblePlayer> createState() => _FilterVisiblePlayerState();
}

class _FilterVisiblePlayerState extends State<FilterVisiblePlayer> {
  //recebe uma copia do filtro que esta na HomeStore
  final FilterSearchStore filterStoreGet = GetIt.I<FilterSearchStore>();

  final PlayerStore playerStore = GetIt.I<PlayerStore>();
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        playerStore.setFilter(widget.filterStore);
