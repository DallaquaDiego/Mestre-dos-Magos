...
mixin _$PlayerStore on _PlayerStore, Store {
  ...
  int get itemCount => (_$itemCountComputed ??=
          Computed<int>(() => super.itemCount, name: '_PlayerStore.itemCount'))
      .value;
  ...
  bool get showProgress =>
      (_$showProgressComputed ??= Computed<bool>(() => super.showProgress,
              name: '_PlayerStore.showProgress'))
          .value;

  late final _$filterStoreAtom =
      Atom(name: '_PlayerStore.filterStore', context: context);
  ...
  late final _$_listPlayerAtom =
      Atom(name: '_PlayerStore._listPlayer', context: context);
  ...
  late final _$_listSearchAtom =
      Atom(name: '_PlayerStore._listSearch', context: context);

  ObservableList<Player> get listSearch {
    _$_listSearchAtom.reportRead();
    return super._listSearch;
  }

  @override
  ObservableList<Player> get _listSearch => listSearch;

  @override
  set _listSearch(ObservableList<Player> value) {
  ...
  late final _$_loadingAtom =
      Atom(name: '_PlayerStore._loading', context: context);
  ...
  late final _$_errorAtom = Atom(name: '_PlayerStore._error', context: context);
  ...
  late final _$_pageAtom = Atom(name: '_PlayerStore._page', context: context);
  ...
  late final _$_lastPageAtom =
      Atom(name: '_PlayerStore._lastPage', context: context);
  ...
  late final _$refreshDataAsyncAction =
      AsyncAction('_PlayerStore.refreshData', context: context);
  ...
  late final _$loadDataAsyncAction =
      AsyncAction('_PlayerStore.loadData', context: context);
  ...
  void setListSearch(List<Player> newPlayers) {
    final _$actionInfo = _$_PlayerStoreActionController.startAction(
        name: '_PlayerStore.setListSearch');
    try {
      return super.setListSearch(newPlayers);
    } finally {
      _$_PlayerStoreActionController.endAction(_$actionInfo);
    }
  }
  ...
  void loadNextPage() {
    final _$actionInfo = _$_PlayerStoreActionController.startAction(
        name: '_PlayerStore.loadNextPage');
    try {
  ...
  void addNewPlayers(List<Player> newPlayers) {
    final _$actionInfo = _$_PlayerStoreActionController.startAction(
        name: '_PlayerStore.addNewPlayers');
    try {
